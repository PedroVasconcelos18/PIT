...
<?php $sql = $conn->prepare("SELECT * FROM vagas WHERE categoria = 'Limp';");
$sql->execute();
...
<table class='table table-striped'>";
    foreach ($rows as $row) {
        ...
        <td><h3>  <div class='verMais'  align='center'><a class='btn btn-primary' href='./vagacompleta.php?id=$row->ID'>Ver mais</a> </div>
        </td>
        ";
